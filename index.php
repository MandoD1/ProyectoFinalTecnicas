...
<section id="hero">
    <div class="hero-text">
        <h1>¿Crees necesitar ayuda en salud mental?</h1>
        <p>Un diagnóstico para tu paz mental. Aquí encontrarás un test que te dirá si necesitas o no ayuda profesional.</p>
        <a href="test.php">Realizar Test</a>
    </div>
    <div class="hero-img">
        <img src="https://budamarketing.es/wp-content/uploads/2021/07/psicologo-online.png" alt="Psicologo Online">
    </div>
</section>
